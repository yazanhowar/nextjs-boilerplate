...
export const BANKS: BankConfig[] = [
  ...
  { id: 2,  ticker: 'THBK',  name: 'Housing Bank',                   nameAr: 'بنك الإسكان للتجارة والتمويل', shortName: 'HBTF',         domain: 'hbtf.com',
  ...
  { id: 3,  ticker: 'JOKB',  name: 'Jordan Kuwait Bank',             nameAr: 'البنك الأردني الكويتي', shortName: 'JKB',          domain: 'jkb.com',
  ...
  { id: 13, ticker: 'INVB',  name: 'Invest Bank',                    nameAr: 'البنك الاستثماري', shortName: 'InvestBank',   domain: 'investbank.jo',
  ...
  { id: 14, ticker: 'ABCO',  name: 'Bank ABC Jordan',                nameAr: 'بنك ABC الأردن', shortName: 'Bank ABC',     domain: 'bank-abc.com',
