...
export const BANKS: BankConfig[] = [
  { id: 1,  ticker: 'ARBK',  name: 'Arab Bank',                       nameAr: 'البنك العربي',                  shortName: 'Arab Bank',  domain: 'arabbank.jo',
  ...
  { id: 2,  ticker: 'THBK',  name: 'Housing Bank',                    nameAr: 'بنك الإسكان',                   shortName: 'HBTF',       domain: 'hbtf.com',
    logoUrl: 'https://hbtf.com/uploads/2021/09/2109-housing-bank-website-logos.jpg',
  ...
  { id: 3,  ticker: 'JOKB',  name: 'Jordan Kuwait Bank',              nameAr: 'بنك الأردن الكويت',             shortName: 'JKB',        domain: 'jkb.com',
  ...
  { id: 4,  ticker: 'CAPL',  name: 'Capital Bank',                    nameAr: 'كابيتال بنك',                   shortName: 'Capital',    domain: 'capitalbank.jo',
  ...
  { id: 5,  ticker: 'ETHD',  name: 'Bank al Etihad',                  nameAr: 'بنك الاتحاد',                   shortName: 'Etihad',     domain: 'bankaletihad.com',
  ...
  { id: 6,  ticker: 'CABK',  name: 'Cairo Amman Bank',                nameAr: 'بنك القاهرة عمان',              shortName: 'CAB',        domain: 'cab.jo',
    logoUrl: gf('cab.jo'),
    primaryColor: '#00529B', sector: 'conventional', isHBTF: false, description: 'Operates 103 branches in Jordan and 22 in Palestine.' },

  { id: 7,  ticker: 'AHLI',  name: 'Jordan Ahli Bank',                nameAr: 'البنك الأهلي الأردني',          shortName: 'Ahli',       domain: 'ahli.com',
    logoUrl: gf('ahli.com'),
  ...
  { id: 8,  ticker: 'AJIB',  name: 'Arab Jordan Investment Bank',     nameAr: 'بنك الاستثمار العربي الأردني',  shortName: 'AJIB',       domain: 'ajib.com',
    logoUrl: gf('ajib.com'),
    primaryColor: '#1B3A6B', sector: 'conventional', isHBTF: false, description: 'Corporate and investment banking specialist.' },

  { id: 9,  ticker: 'JOIB',  name: 'Jordan Islamic Bank',             nameAr: 'البنك الإسلامي الأردني',        shortName: 'JIB',        domain: 'jordanislamicbank.com',
  ...
  { id: 10, ticker: 'SAFWA', name: 'Safwa Islamic Bank',              nameAr: 'بنك صفوة الإسلامي',             shortName: 'Safwa',      domain: 'safwabank.com',
  ...
  { id: 11, ticker: 'IIAB',  name: 'Islamic International Arab Bank', nameAr: 'البنك العربي الإسلامي الدولي',  shortName: 'IIAB',       domain: 'iiabank.com.jo',
  ...
  { id: 12, ticker: 'BOJX',  name: 'Bank of Jordan',                  nameAr: 'بنك الأردن',                    shortName: 'BOJ',        domain: 'bankofjordan.com',
  ...
  { id: 13, ticker: 'INVB',  name: 'Invest Bank',                     nameAr: 'بنك الاستثمار',                 shortName: 'InvestBank', domain: 'investbank.jo',
  ...
  { id: 14, ticker: 'ABCO',  name: 'Bank ABC Jordan',                 nameAr: 'المؤسسة العربية المصرفية',      shortName: 'Bank ABC',   domain: 'bank-abc.com',
  ...
  { id: 15, ticker: 'JCBK',  name: 'Jordan Commercial Bank',          nameAr: 'البنك التجاري الأردني',          shortName: 'JCB',        domain: 'jcbank.com.jo',
