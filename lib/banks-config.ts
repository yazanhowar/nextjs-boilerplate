...
export const BANKS: BankConfig[] = [
  ...
  { id: 3, ticker: 'JOKB', name: 'Jordan Kuwait Bank', nameAr: 'بنك الأردن الكويت', shortName: 'JKB', domain: 'jkb.com', logoUrl: 'https://www.google.com/s2/favicons?domain=jkb.com&sz=64', primaryColor: '#004A97', sector: 'conventional', isHBTF: false, description: 'KIPCO Group subsidiary, record JOD 194M profit in 2024.' },
  { id: 4, ticker: 'CAPL', name: 'Capital Bank', nameAr: 'كابيتال بنك', shortName: 'Capital', domain: 'capitalbank.jo', logoUrl: 'https://www.google.com/s2/favicons?domain=capitalbank.jo&sz=64', primaryColor: '#E4002B', sector: 'conventional', isHBTF: false, description: "Jordan's third-largest bank with operations in Jordan and Iraq." },
  ...
  { id: 11, ticker: 'IIAB', name: 'Islamic International Arab Bank', nameAr: 'البنك العربي الإسلامي الدولي', shortName: 'IIAB', domain: 'iiabank.com.jo', logoUrl: 'https://www.google.com/s2/favicons?domain=iiabank.com.jo&sz=64', primaryColor: '#006C35', sector: 'islamic', isHBTF: false, description: 'Wholly owned Islamic banking subsidiary of Arab Bank plc, 47 Jordan branches.' },
