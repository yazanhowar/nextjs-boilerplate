...
export const BANKS: BankConfig[] = [
  // id 1: Arab Bank — google favicon works (red/white double-loop logo)
  { id: 1,  ticker: 'ARBK',  name: 'Arab Bank',                      nameAr: 'البنك العربي',                   shortName: 'Arab Bank',   domain: 'arabbank.com.jo',       logoUrl: gf('arabbank.com.jo'),     primaryColor: '#CC0000', sector: 'conventional', isHBTF: false, description: "Jordan's largest bank, with 600+ branches across 30 countries." },
  // id 2: Housing Bank — no favicon available; colored initials look better
  { id: 2,  ticker: 'THBK',  name: 'Housing Bank',                   nameAr: 'بنك الإسكان',                 shortName: 'HBTF',        domain: 'hbtf.com',              logoUrl: '',                        primaryColor: '#004D8F', sector: 'conventional', isHBTF: true,  description: "Jordan's second-largest bank and market leader in retail banking." },
  // id 3: JKB — no favicon; initials
  { id: 3,  ticker: 'JOKB',  name: 'Jordan Kuwait Bank',             nameAr: 'بنك الأردن الكويت',           shortName: 'JKB',         domain: 'jkb.com',               logoUrl: '',                        primaryColor: '#004A97', sector: 'conventional', isHBTF: false, description: 'KIPCO Group subsidiary, record JOD 194M profit in 2024.' },
  // id 4: Capital Bank — favicon works
  { id: 4,  ticker: 'CAPL',  name: 'Capital Bank',                   nameAr: 'كابيتال بنك',                 shortName: 'Capital',     domain: 'capitalbank.jo',        logoUrl: gf('capitalbank.jo'),      primaryColor: '#E4002B', sector: 'conventional', isHBTF: false, description: "Jordan's third-largest bank with operations in Jordan and Iraq." },
  // id 5: Bank al Etihad — favicon works
  ...
  // id 6: Cairo Amman Bank — favicon works
  ...
  // id 7: Jordan Ahli Bank — favicon works
  ...
  // id 9: Jordan Islamic Bank — favicon works
  ...
  // id 11: IIAB — no favicon; initials
  { id: 11, ticker: 'IIAB',  name: 'Islamic International Arab Bank',nameAr: 'البنك العربي الإسلامي الدولي', shortName: 'IIAB',        domain: 'iiabank.com.jo',        logoUrl: '',                        primaryColor: '#006C35', sector: 'islamic',      isHBTF: false, description: 'Wholly owned Islamic banking subsidiary of Arab Bank plc, 47 Jordan branches.' },
  // id 12: Bank of Jordan — favicon works
  ...
  // id 13: Invest Bank — favicon works
  ...
  // id 15: Jordan Commercial Bank — favicon works
