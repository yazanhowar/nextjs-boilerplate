...
function mdToHtml(md) {
  ...
  while (i < lines.length) {
    ...
    if (t === '---' || t === '***') { html += '<hr class="cf-hr">'; i++; continue }
    if (t.charAt(0) === '#') { var hl0 = 0; while (hl0 < t.length && t.charAt(hl0) === '#') hl0++; html += '<div class="cf-h cf-hh' + Math.min(hl0, 3) + '">' + cfInline(t.slice(hl0).trim()) + '</div>'; i++; continue }
