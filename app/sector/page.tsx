...
function mdLite(text: any) {
  ...
  t = t.replace(/^#{1,6}\s*(.+)$/gm, '<strong class="sk-h">$1</strong>');
  t = t.replace(/^[-*]\s+(.+)$/gm, '\u2022 $1');
